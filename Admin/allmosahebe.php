...
if (($_SESSION['type']>0)) {
    ...
    <head>
        ...
        <script src="js/allmosahebe.js"></script>
    </head>
    <body dir="rtl">
    <div id="wrapper">
        <?php
...
<!--                                    <option value="تجهیزات مراسم">تجهیزات مراسم</option>-->
<!--                                    <option value="بهداشت سلامت">بهداشت سلامت</option>-->
