...
//                            }
    ...
    <div id="wrapper">
        ...
        <form action="<?php echo $URL ?>" method="post" enctype="multipart/form-data" onsubmit="return validateFormdata(1)">
                ...
                <div class="container2">
                    <div class="row">
                        ...
                        <div class="block">
                            ...
                            <input type="checkbox" name="pishnevis" value="1" <?php if ($pishnevis==1) echo "checked";?>/>پیش نویس بودن
                            <div class="block">
                                <div class="">
                            ...
                            <div class="block">
                                <div class="">
                                    ...
                                    <select id="dastebandi" class="form-control width700" name="dastebandi">
                                        ...
                                        <option value="آزاد" selected>سایر</option>
                                    </select>
                                </div>
                            </div>
                    </div>
