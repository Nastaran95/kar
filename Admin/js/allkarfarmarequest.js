...
$(document).ready(function() {
    ...
    $.get("allKarfarmaRequestPagination.php", {page:1, limit:range,type:type,query:"=====+++=====",category:"all"}, function (data, status) {
        $("#results").html(data);
    });
    ...
    $("#results").on( "click", ".pagination a", function (e){
        ...
        $.get("allKarfarmaRequestPagination.php", {page:page, limit:range,type:type,query:"=====+++=====",category:"all"}, function (data, status) {
    ...
    $('#sarching').bind("enterKey",function(e){
        ...
        $(".loading-div").show(); //show loading element
        range = $("#limit").find(":selected").text();
        $.get("allKarfarmaRequestPagination.php", {page:1, limit:range,type:type,query:searchdata,category:"all"}, function (data, status) {
            $(".loading-div").hide(); //show loading element
            $("#results").html(data);
        });
    });
